...
:root {
  ...
  --orange:  #CD533B;  /* the one accent: links, section numbers, hovers */
  --orange-deep: #B0432D; /* small accent text and white-on-accent (AA) */
...
Rules:
- Orange is an accent, not a fill. Use it for links, section numbers, labels and hover states.
- `--orange` (4.1:1 on the page) is for large text, headings, arrows and rules. Small accent text and white-on-accent use `--orange-deep`.
...
- **Buttons**: rounded pill (`border-radius: 999px`). Cream on navy, navy on cream. Hover turns orange.
- **Chips**: one shared rule, 12px Manrope 600, orange outline. Chips inside app screenshots are product UI and are not restyled.
